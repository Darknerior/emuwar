...
public class LevelEditor : EditorWindow {
    ...
    private Vector3 position, scale = Vector3.one, gridSize = new Vector3(1f, 1f, 1f);
    ...
    private void OnGUI(){
        ...
        // Buttons for apply functions to selected objects
    ...
    private void PlacePrefab() {
        ...
        if (prefabIndex >= 0 && prefabIndex < prefabs.Length) {
            ...
            // If an environment parent doesn't exist, create a new one
    ...
    /// <summary>
    /// Destroy selected objects, now instead of clicking delete on your keyboard you can click it in a fancy window like a cool person
    /// </summary>
